...
// The Hero component represents the main highlight section of the page.
// It includes a headline, description, and a featured video with overlay details.
export default function Hero() {
  return (
    ...
    <main className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-center">
      ...
      {/* Right section: Video and overlay */}
      <div className="lg:col-span-2">
